...
import { SiSpringboot, SiPostgresql, SiTypescript, SiMysql, SiRedis, SiApachemaven, SiJunit5, SiAngular, SiNodedotjs, SiFirebase, SiTailwindcss, SiMongodb } from 'react-icons/si';
